"""
AutoMAE Training Script for PathMNIST
...
from datasets.path_dataset import PathMNISTDataset, PathMNISTDataPrefetcher, fast_collate_pathmnist
...
def get_args_parser():
    parser = argparse.ArgumentParser('AutoMAE PathMNIST pre-training', add_help=False)
    ...
    parser.add_argument('--pretrained_weight', type=str, default="",
                        help='Path to pretrained scorer (optional for PathMNIST)')
...
def main(args):
    ...
    print('='*80)
    print('AutoMAE Training on PathMNIST')
    print('='*80)
    ...
    dataset_train = PathMNISTDataset(
        split='train',
    ...
    # Create dataloader
    collate_fn = lambda b: fast_collate_pathmnist(b, torch.contiguous_format)
