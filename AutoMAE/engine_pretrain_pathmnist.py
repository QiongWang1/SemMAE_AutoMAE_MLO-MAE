"""
Training engine for AutoMAE on PathMNIST
...
from models_mae_pathmnist import AdversarialLoss
from datasets.path_dataset import PathMNISTDataPrefetcher
import os
...
def train_one_epoch(
    ...
    prefetcher = PathMNISTDataPrefetcher(data_loader)
